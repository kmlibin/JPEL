...
export default function AboutPage() {
  return (
    <div className="justify-content relative flex h-full w-full flex-col items-center bg-customBeige bg-opacity-20 pt-[10rem]">
      <div className="h-[90%] w-[95%]">
        <div className="relative flex h-full w-full flex-col items-center justify-center bg-customBeige bg-opacity-40">
          ...
          >
            {/* images */}
            <div
              className={`${textFont.className}  ml-4 shadow-element float-right mr-[-5rem] flex flex-col items-center border-4 border-customBeige bg-customBrown p-4 text-customBeige`}
            >
              <Image
            ...
            <div className="w-2/3 ">
              ...
              <p className="my-5 px-4">
                ...
                nisl. Enim ut tellus elementum sagittis vitae et leo. Massa eget
                egestas purus viverra accumsan. Massa sed elementum tempus
                egestas sed sed risus pretium. Velit ut tortor pretium viverra
                suspendisse potenti nullam ac. Auctor eu augue ut lectus arcu
                bibendum at. In nulla posuere sollicitudin aliquam ultrices
                sagittis orci a. Consequat ac felis donec et odio pellentesque
                ...
                amet luctus venenatis. Malesuada pellentesque elit eget gravida
                cum sociis natoque. Senectus et netus et malesuada fames ac
                turpis egestas. Convallis convallis tellus id interdum velit
                laoreet id donec ultrices. Ultrices tincidunt arcu non sodales.</p>
                <hr className=" my-8 w-2/3 border-b border-customMediumGreen opacity-20"></hr>
               <p>Lacus sed viverra tellus in hac habitasse platea. Non enim
                praesent elementum facilisis leo vel fringilla. Eros donec ac
                odio tempor orci dapibus. Dolor sit amet consectetur adipiscing
                elit duis tristique. Ultricies mi eget mauris pharetra et. Amet
                nulla facilisi morbi tempus. Posuere lorem ipsum dolor sit amet
                consectetur. Lacinia quis vel eros donec ac odio tempor orci
                dapibus. Id diam maecenas ultricies mi eget mauris pharetra et.
                Placerat vestibulum lectus mauris ultrices eros in. A iaculis at
                erat pellentesque adipiscing. Proin sed libero enim sed
                faucibus.
            </p>
            </div>
          </div>
