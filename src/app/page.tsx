...
export default function Home() {
  return (
    <main className="flex flex-col bg-customWhite">
      ...
      {/* fun facts section */}
      <div className=" relative flex w-full items-center justify-center bg-customLightGreen md:min-h-[100vh] lg:min-h-[70vh]">
        <h2
        ...
        <div className="relative flex h-full w-full items-center justify-end rounded bg-customLightGreen">
          <div className="left-[7%] top-1/2 transform -translate-y-1/2 absolute rounded w-1/3 bg-customDarkGreen bg-opacity-80 p-5">
            <div className=" flex min-h-full w-full flex-col items-start  text-left">
              <p
                className={`${textFont.className} min-w-full rounded bg-customBrown p-5 text-3xl`}
              >
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
          ...
          <div className="flex h-full md:w-4/5 lg:w-2/3 justify-end rounded-[50%]">
