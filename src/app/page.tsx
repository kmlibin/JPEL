  ...
  return (
    <main className="flex flex-col bg-customWhite">
      ...
      <div className="relative mx-auto flex w-full items-center justify-center bg-customWhite">
        ...
        <div className="shadow-element-grey flex w-5/6 h-[52vh] my-[10rem] items-center justify-center bg-customBeige bg-opacity-30">
        <div className="shadow-element my-40 flex w-[95%] max-h-[90%] items-center  justify-center rounded bg-customLightGreen bg-opacity-50 p-8">
      ...
      {/* buy beef section */}
      <div className="relative mx-auto flex w-full h-full items-center justify-center bg-customWhite">
        <h2
