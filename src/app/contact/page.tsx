...
export default function ContactPage() {
  return (
    <div className="justify-content flex h-[120vh] w-full flex-col items-center justify-end bg-customBeige bg-opacity-20">
      <div className="relative h-full w-full overflow-hidden flex items-end">
        ...
        <div className="relative flex h-[90%] w-[100%] flex-col items-center justify-end">
          ...
          <div className="flex h-5/6 w-3/4 shadow-element rounded">
            {/* contact info */}
            <div
              className={`${textFont.className} flex h-full flex-1 flex-col items-center justify-evenly bg-customBeige  py-4 `}
            >
              <div className="w-3/4">
            ...
            {/* contact form */}
            <div className="flex min-h-[100%] flex-1 flex-col items-center justify-center bg-customDarkGreen">
              <form
